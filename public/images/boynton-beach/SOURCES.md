...
| | |
|---|---|
| Source | Unsplash — https://unsplash.com/photos/people-sailing-on-river-near-parking-lot-ZpZxpOaZWec |
| Photographer | Richard Sagredo (@sagredophotography) |
| Licence | Unsplash License (free commercial use; credit given on the page anyway) |
| Photographer's location tag | Boynton Beach, FL, USA — titled "Florida sunset on the water by the inlet" |
...
Boynton Inlet and must not imply it is within the city. The identification rests on the
photographer's tag plus the scene matching the inlet; it has not been confirmed on site.

The subject sits right of centre (boat at ~76% of the width), so the article sets
`heroImagePosition: '68% 50%'` to keep the boat in the phone crop.
