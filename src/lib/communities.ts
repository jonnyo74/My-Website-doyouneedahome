...
export const cities: CommunityItem[] = [
  {
    ...
    localLoves: [
      ...
      'CityPlace — shopping, restaurants, live entertainment, and rooftop dining',
    ...
    subNeighborhoods: [
      ...
      { name: 'Downtown / CityPlace', description: 'Urban condo living steps from Clematis Street, the Brightline, waterfront parks, and every convenience.' },
    ...
    dining: [
      ...
      'RH Rooftop Restaurant at CityPlace — spectacular views',
    ...
    popularNeighborhoods: ['El Cid', 'SoSo', 'Flamingo Park', 'Northwood Village', 'Downtown / CityPlace', 'Palm Beach Lakes'],
    photos: [
