...
export const neighborhoods: CommunityItem[] = [
  ...
  // ── PALM BEACH GARDENS ───────────────────────────────────────
  {
    ...
    description: 'Home to major golf championships, five courses, a world-class spa, and resort-style residential living.',
    overview:
      'PGA National is one of Palm Beach County\'s most recognized communities, anchored by PGA National Resort & Spa and five championship golf courses including the legendary Champion Course. Home styles range from attached villas to large estate homes.',
    quickFacts: [
      { label: 'Homes', value: 'Gated villas, townhomes, estates' },
      { label: 'Amenities', value: 'Five golf courses, spa, club dining, fitness' },
    ],
    photos: [
  ...
  },
  {
    ...
    type: 'Neighborhood',
    region: 'Palm Beach Gardens',
    description: 'Palm Beach Gardens\' newest and largest master-planned community, with new construction homes, parks, and A-rated schools.',
    overview:
      'Avenir is a transformative 4,500-acre master-planned development on the western edge of Palm Beach Gardens. With thousands of new homes from top builders, a future town center, and expansive natural preserves, Avenir is one of South Florida\'s most exciting new communities.',
    quickFacts: [
      { label: 'Homes', value: 'New construction single-family and estate homes' },
      { label: 'Amenities', value: 'Resort amenity center, parks, nature trails, planned retail' },
    ],
  },
  {
    slug: 'mirasol',
