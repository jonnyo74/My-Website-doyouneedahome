...
export const cities: CommunityItem[] = [
  {
    ...
    subNeighborhoods: [
      ...
      { name: 'SoSo (South of Southern)', description: 'A renovation-heavy area of WPB — modern updates on historic homes, close to downtown and walkable.' },
  ...
  },
  {
    ...
    highlights: [
      ...
      'Lion Country Safari, Wellington Environmental Preserve, and Lake Wellington Waterfront Park are all nearby outdoor options',
    ],
    keyLinks: [
  ...
  },
  {
    ...
    description: 'A coastal city with beach parks, a downtown centred on Mizner Park, Florida Atlantic University, and housing ranging from condominiums to private club communities.',
    overview:
      'Boca Raton covers a wide range of housing: oceanfront and downtown condominiums, canal-front homes in private club communities such as Royal Palm Yacht & Country Club, residential club communities including Boca West and Broken Sound, and inland single-family neighbourhoods. Purchase prices and recurring costs vary widely across those types, so compare specific properties with their dues, club obligations, and assessments included rather than by area label.\n\nOne thing to establish early: \'East Boca\' and \'West Boca\' are informal terms, not municipal districts. City boundaries are irregular and a Boca Raton mailing address may sit in unincorporated Palm Beach County, which differs for taxes, services, and permitting — so confirm the jurisdiction for the exact address.\n\nMizner Park anchors downtown with dining, shops, the Boca Raton Museum of Art, and an amphitheatre. Spanish River, Red Reef, and South Beach are City beach parks; parking, permits, hours, and conditions change, so check the City before visiting. Florida Atlantic University and Lynn University both sit in the city, and Boca Raton Regional Hospital, part of Baptist Health, provides 24-hour emergency services.',
    lifestyle: 'Boca Raton has a high concentration of private clubs alongside oceanfront and Intracoastal condominiums, gated golf communities, and inland single-family neighbourhoods. A lot of organised social life runs through the private clubs — Boca West, Broken Sound, Woodfield, Addison Reserve — and membership terms differ between them, so confirm what a specific property requires. The city also has public options that need no membership: Mizner Park, the Boca Raton Museum of Art, Sugar Sand Park, the City beach parks, and university programming at FAU and Lynn. Dining is concentrated along Federal Highway, Palmetto Park Road, and downtown.',
    localLoves: [
      ...
      'Bark Beach at Spanish River Park — off-leash dog beach between lifeguard towers 18 and 20, now open seven days a week with a paid pass',
      'Boca Raton Museum of Art — permanent collection, rotating exhibitions, and an art school',
    ...
    subNeighborhoods: [
      { name: 'Royal Palm Yacht & Country Club', description: 'A private club community with canal-front and Intracoastal homes, golf, and a marina. The club states membership is by invitation. Dockage, canal depth, and bridge clearance vary by address.' },
      { name: 'Boca West', description: 'A residential private club community. The club states that membership requires owning a home in the community, and describes four golf courses, six restaurants, tennis and pickleball, and a spa and fitness centre. Home styles run from villas to estate homes.' },
      { name: 'Broken Sound', description: 'A private club community in northern Boca. The club describes two 18-hole championship courses, tennis and pickleball, spa and fitness, and several dining venues. Housing includes estate homes and condominiums.' },
      { name: 'Woodfield Country Club', description: 'A gated golf community with a private course and single-family homes. Confirm membership structure, whether it is required, dues, and HOA obligations from the current club and association documents.' },
      { name: 'Addison Reserve', description: 'A gated country club community with Mediterranean-inspired architecture, golf, and club facilities. Membership requirements and dues are set by the club — request them in writing.' },
      { name: 'Boca del Mar', description: 'An established community with canals, golf, and a mix of single-family homes, villas, and condominiums. Association obligations vary by sub-association, so check the specific one.' },
      { name: 'Long Lake Estates', description: 'A non-gated enclave of custom estate homes on large lakefront lots.' },
      { name: 'Bocaire Country Club', description: 'A small private golf community. Membership terms, including any cap on the roster, come from the club directly — confirm them in writing before an offer.' },
    ],
    dining: [
    ...
    highlights: [
      'Royal Palm Yacht & Country Club is a private club community with a marina; the club states membership is by invitation, and dockage varies by address',
      'Boca West is a residential private club community — the club states membership requires owning a home there, and describes four golf courses, six restaurants, and a spa and fitness centre',
      'Mizner Park is an open-air mixed-use centre downtown with dining, shops, the Boca Raton Museum of Art, and an amphitheatre',
      'Boca Raton Regional Hospital, part of Baptist Health, provides 24-hour emergency services and a broad range of specialties',
      'The Tri-Rail station at 680 Yamato Road provides regional commuter-rail access; check the live schedule and last-mile connections',
      'Florida Atlantic University and Lynn University both sit in the city and run year-round academic and cultural programming',
      'Spanish River, Red Reef and South Beach are City beach parks — parking, permits, hours and conditions change, so check the City before you go',
      'School assignment is address-specific: verify current assignment for an exact address with the School District of Palm Beach County',
    ],
    keyLinks: [
  ...
  },
  {
    ...
    subNeighborhoods: [
      ...
      { name: 'Gulf Stream', description: 'A small incorporated town on the ocean just north of Delray — private oceanfront estates on A1A with old-Florida character. Inventory is limited.' },
  ...
  },
  {
    ...
    subNeighborhoods: [
      ...
      { name: 'Boynton Beach Marina District', description: 'The emerging waterfront corridor along the Intracoastal — a mix of condo buildings, townhomes, and dining with direct marina access, with Town Square redevelopment ongoing nearby.' },
    ...
    quickFacts: [
      ...
      { label: 'Key advantage', value: 'Close to Boca Raton and Delray Beach amenities, with a redeveloping downtown of its own' },
  ...
  },
  {
    ...
    highlights: [
      ...
      'Historic housing stock is being renovated throughout the city',
  ...
  },
  {
    ...
    type: 'City',
    region: 'Western Palm Beach County',
    description: 'A mature master-planned village with extensive parks and a range of single-family homes, set between Wellington and the coast.',
    overview:
    ...
    quickFacts: [
      ...
      { label: 'Key advantage', value: 'Larger lots and extensive public parks, with Wellington next door' },
      ...
      { label: 'Standout feature', value: 'Wellington\'s International Polo Club is about 5 minutes away' },
    ],
    hasMembershipCommunities: false,
  ...
  },
  {
    ...
    subNeighborhoods: [
      ...
      { name: 'Estate Section', description: 'Oceanfront and ocean-to-lake estates on the island\'s widest lots, Addison Mizner and John Volk historic architecture, and the highest concentration of landmark properties in the county.' },
  ...
  },
  {
    ...
    subNeighborhoods: [
      ...
      { name: 'Ocean Trace', description: 'A small condo community directly on the ocean, with beachfront access in northern Palm Beach County.' },
  ...
  },
  {
    ...
    subNeighborhoods: [
      ...
      { name: 'Harbour Isles / Waterway', description: 'Canal-front homes with private docks directly off the Intracoastal — canal frontage with direct Intracoastal access — confirm dock rights, canal depth and bridge clearance for the specific address.' },
      ...
      { name: 'Village of North Palm Beach Condos', description: 'A mix of smaller condo buildings concentrated near the village center and Intracoastal — generally the lower end of the price range within the village; confirm any rental restrictions with the association.' },
    ],
    dining: [
  ...
  },
  {
    ...
    subNeighborhoods: [
      ...
      { name: 'Country Club Drive / Village Interior', description: 'Quiet residential streets with mid-century and updated single-family homes — generally the lower end of the Tequesta price range, away from the waterfront.' },
    ],
    dining: [
    ...
    highlights: [
      ...
      'A small market within village limits, so the number of available listings is typically limited',
    ],
    keyLinks: [
  ...
  },
  {
    ...
    subNeighborhoods: [
      { name: 'Tradition', description: 'Port St. Lucie\'s largest New Urbanist master-planned community — with its own town center, hospital, and events calendar.' },
      ...
      { name: 'East Port St. Lucie', description: 'Established residential neighborhoods east of US-1 with Intracoastal and river access — older housing stock and canal homes with waterfront access.' },
  ...
  },
  {
    ...
    overview:
      'Westlake is one of the most closely watched new communities in Florida — incorporated as a city in 2016 and built from the ground up by Minto Communities on 3,800 acres in western Palm Beach County. It sits between Wellington and Loxahatchee, designed to eventually house 15,000+ homes across a range of product types, with a town center, retail, schools, parks, and every amenity being developed in phases.\n\nThe pitch is straightforward: new construction quality, resort-style community amenities, and Palm Beach County access at price points that the coastal and mid-county markets can no longer deliver. Westlake Adventure Park — a 20-acre recreational facility with a lazy river, splash pad, tennis courts, and event lawn — anchors the community\'s lifestyle offering. Tamarind Cove, the community\'s waterfront feature, adds a lake and boating element that most western county communities lack. Westlake has been delivering homes since 2018 and continues to build out in phases. Confirm the current HOA and CDD obligations for a specific address — early-phase and later-phase sections can differ.',
    lifestyle: 'Westlake is an all-new-construction market: modern floor plans and resort amenities at pricing below Palm Beach Gardens and Wellington, in an early-phase master-planned community. Build-out is still in progress, so the amenities, retail, and road network described in marketing may arrive on a different schedule than expected — check what is actually delivered today. The lifestyle is activity-oriented and community-focused — the Adventure Park, farmers market events, and planned town center are the social anchors. Wellington and Royal Palm Beach provide dining and shopping within 10–15 minutes. The commute to the coast is real, but for buyers prioritizing space, newness, and value, Westlake makes the trade explicitly and without apology.',
    localLoves: [
    ...
    subNeighborhoods: [
      ...
      { name: 'Meadow Cove', description: 'Mid-phase single-family neighborhood with a range of floor plans and lot configurations, positioned adjacent to the community park.' },
      ...
      { name: 'Future Phases (North / West)', description: 'Westlake\'s build-out continues to add new phases. What is built today and what is planned are different things — confirm which amenities and retail are actually open.' },
    ],
    dining: [
    ...
    highlights: [
      ...
      'Amenities and infrastructure are being delivered in phases — confirm what is open before relying on it',
    ],
    keyLinks: [
  ...
  },
  {
    ...
    quickFacts: [
      ...
      { label: 'Key advantage', value: 'Atlantic oceanfront living with direct beach access and well-known shore diving at Phil Foster Park' },
  ...
  },
  {
    ...
    lifestyle: 'What Hobe Sound offers is low density and protected land: Jonathan Dickinson State Park, the Hobe Sound National Wildlife Refuge, and Blowing Rocks Preserve wrap the community, and much of the surrounding acreage cannot be developed. Housing runs from modest mainland cottages and gated golf communities to oceanfront estates on Jupiter Island. Jupiter is 10 minutes south for every amenity. The peace here is not accidental — it is protected by statute and fiercely defended by the people who live here.',
    localLoves: [
      ...
      'Peck Lake Park — a mile of boardwalk through pine flatwoods, baygall, oak hammock and mangrove to an observation deck on the Indian River Lagoon, free and open sunrise to sunset',
    ...
    outdoorActivities: [
      ...
      'Peck Lake Park — a free Martin County park off Gomez Avenue where a mile of boardwalk crosses four habitats to a covered deck on the Intracoastal',
      'Peck Lake — the sheltered stretch of Intracoastal off that shoreline, a well-known anchorage and estuary habitat reached by boat, excellent for birding',
    ],
    ...
    photos: [
      ...
      '/images/hobe-sound/local-peck-lake-observation-deck.jpg',
      '/images/hobe-sound/local-peck-lake-boardwalk-mangrove.jpg',
  ...
  },
  {
    ...
    subNeighborhoods: [
      { name: 'Harbour Ridge Yacht & Country Club', description: 'A private equity club on the St. Lucie River with two Arnold Palmer–designed golf courses, a full-service marina, tennis, croquet, and an active social calendar. Membership required, equity buy-in.' },
  ...
  },
  {
    ...
    type: 'City',
    region: 'Treasure Coast',
    description: 'Stuart\'s working waterfront village on the Manatee Pocket — charter fishing boats, waterfront restaurants, and Old Florida character on the Treasure Coast.',
    ...
    subNeighborhoods: [
      ...
      { name: 'Salerno Road / US-1 Corridor', description: 'The community\'s mainland residential core — established homes, cottages, and modest single-family properties within 5 minutes of the Pocket waterfront.' },
    ...
    highlights: [
      ...
      'Canal and waterfront homes here have Intracoastal access — confirm dock rights, depth and bridge clearance by address',
  ...
  },
  {
    ...
    type: 'City',
    region: 'Barrier Island',
    description: 'A small incorporated beachfront town of oceanfront estates.',
    overview:
...
export const neighborhoods: CommunityItem[] = [
  // ── JUPITER ──────────────────────────────────────────────────
  {
    ...
    subNeighborhoods: [
      { name: 'Mallory Creek', description: 'Key West-style homes with metal roofs and wide sidewalks, on one of Abacoa\'s more established streets.' },
  ...
  },
  {
    ...
    highlights: [
      ...
      'Build-out is ongoing — confirm which amenities, retail, and roads are open today rather than planned',
    ],
    quickFacts: [
    ...
    hiddenGems: [
      ...
      'Avenir is building out in phases, so the retail and amenities in the marketing may not all be open yet — confirm what is delivered today',
  ...
  // ── BOCA RATON ───────────────────────────────────────────────
  {
    ...
    type: 'Neighborhood',
    region: 'Boca Raton',
    description: 'A private club community in Boca Raton with two 18-hole championship golf courses.',
    overview:
      'Broken Sound is a private club community in Boca Raton. The club describes two 18-hole championship courses — the Old Course and the Club Course — along with tennis and pickleball, a spa and salon, fitness and aquatics, and several dining venues. The club\'s site does not set out whether membership is mandatory for residents, so confirm that, and the current dues and capital contribution, directly with the club in writing.',
    quickFacts: [
  ...
  },
  {
    ...
    type: 'Neighborhood',
    region: 'Boca Raton',
    description: 'A residential private club community in Boca Raton where club membership requires owning a home in the community.',
    overview:
      'Boca West is a residential private club community in Boca Raton. The club states that membership requires ownership of a residence within the community, and describes four championship golf courses, six restaurants, 30 hydro tennis courts, pickleball, a spa and fitness centre, and an aquatic centre. Home styles range from condominiums to single-family homes. Membership category, dues, capital contribution, and transfer terms are set by the club and should be obtained in writing before an offer.',
    quickFacts: [
  ...
  },
  {
    ...
    type: 'Neighborhood',
    region: 'Boca Raton',
    description: 'A private club community in Boca Raton with a marina, golf, and waterfront and canal-front homes.',
    overview:
      'Royal Palm Yacht & Country Club is a private club community in Boca Raton. The club states that membership is by invitation and describes a 60-slip marina among its facilities, alongside golf and racquet sports. Water access is not community-wide: dockage, canal depth, and bridge clearance vary by address, so confirm them for the specific property. Membership terms, dues, and transfer requirements come from the club in writing.',
    quickFacts: [
  ...
  },
  {
    ...
    type: 'Neighborhood',
    region: 'Boca Raton',
    description: 'A gated golf community in Boca Raton with a private course and a range of single-family homes.',
    overview:
      'Woodfield Country Club is a gated golf community in Boca Raton with a private course and a range of single-family homes. Membership structure, whether it is required for residents, dues, and HOA obligations vary and are not something to assume from the community name — request the current club and association documents in writing before making an offer.',
    quickFacts: [
  ...
  // ── JUPITER COUNTRY CLUBS ────────────────────────────────────
  {
    ...
    description: 'A premier waterfront country club on the Intracoastal — deep-water dockage, championship golf, and and estate homes.',
    overview:
  ...
  },
  {
    ...
    highlights: [
      ...
      'A private club community with limited inventory',
    ],
  },
  ...
  // ── JUNO BEACH / NORTH PALM ──────────────────────────────────
  {
    ...
    highlights: [
      ...
      'A newer address in a western Palm Beach County growth corridor',
  ...
  // ── Abacoa Villages ─────────────────────────────────────────────────────────
  {
    ...
    region: 'Jupiter',
    searchCity: 'Jupiter',
    description: 'Key West and Charleston-inspired homes with front porches and alley-loaded garages, on a sidewalk-lined street within Abacoa.',
  ...
  },
  {
    ...
    lifestyle: 'Established, with larger floor plans. Newhaven offers the character of Abacoa with more square footage — sidewalk-lined streets, proximity to Abacoa Community Park, and easy access to Town Center without being right on top of it.',
    highlights: [
  ...
  },
  {
    ...
    lifestyle: 'An established neighborhood of single-family homes with private outdoor space. The neighborhood\'s mature trees and rear-entry garage design keep streetscapes clean and pedestrian-friendly.',
    highlights: [
  ...
  },
  {
    ...
    region: 'Jupiter',
    searchCity: 'Jupiter',
    description: 'Mediterranean-style condos and townhomes in one of Abacoa\'s most central locations — steps to Town Center, and low-maintenance living.',
    ...
    highlights: [
      ...
      'Generally the lower end of the Abacoa price range',
