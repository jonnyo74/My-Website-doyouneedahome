...
const pageLinks = [
  ...
  { href: '/palm-beach-county-market-report', label: 'Palm Beach County Market Report' },
  { href: '/martin-county-market-report', label: 'Martin County Market Report' },
  { href: '/st-lucie-county-market-report', label: 'St. Lucie County Market Report' },
