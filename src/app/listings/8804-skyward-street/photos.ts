// The 46-photo sequence for 8804 Skyward Street, in the exact order John
// specified for the marketing site. Sources are the delivered edits in the
// Lotus Photos folder, compressed to the site's 2048px ceiling; the files with
// T/N suffixes (undisclosed AI twilight composites), S suffixes (watermarked
// virtual staging), and burned-in-text aerials are deliberately excluded and
...
export const PHOTOS: SkywardPhoto[] = [
  ...
  },
  {
    ...
    alt: 'The dining area wrapped in floor-to-ceiling sheers, with a slider opening straight out to the lanai and pool',
    w: 2048, h: 1365,
  },
  {
