        ...
        <div className="mx-auto max-w-6xl">
          <SectionHeading label="The Primary Suite & The Second Floor" title="The primary stays downstairs. The noise stays up.">
            <div className="mt-6 max-w-3xl space-y-5">
              ...
              <p className="sky-body">
                Upstairs, under 9&rsquo;4&rdquo; ceilings and wood floors: four bedroom suites, each
                with its own bath; a sound-insulated media room; a home gym with a full mirrored
                wall; and a loft open to the foyer below.
              </p>
            </div>
          </SectionHeading>
        </div>
